<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\wamp64\www\tp5\public/../application/index\view\cosmetology\cosmetology.html";i:1503067646;s:66:"D:\wamp64\www\tp5\public/../application/index\view\index\head.html";i:1503104117;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>钱峰网-食品零食</title>
...
<!-- <script type="text/javascript" src="__JS__PATH__/zhonglin.js"></script> -->
    ...
    <div class="advertisement w1200">
    	<p style="text-align:center;font-size:15px;color:#000;line-height:74px;">食品零食商家logo</p>
    </div> -->
        
    <!--公司logo栏-->
    <div class="beaut-lg w1200">
    	<ul>
        	<li><a href="<?php echo url('index/shopslogo/shopslogo'); ?>"><img src="__IMAGE__PATH__/beaut-lg-tu1.gif" /></a></li>
        	<li><a href="<?php echo url('index/shopslogo/shopslogo'); ?>"><img src="__IMAGE__PATH__/beaut-lg-tu2.gif" /></a></li>
        	<li><a href="<?php echo url('index/shopslogo/shopslogo'); ?>"><img src="__IMAGE__PATH__/beaut-lg-tu1.gif" /></a></li>
        	<li><a href="<?php echo url('index/shopslogo/shopslogo'); ?>"><img src="__IMAGE__PATH__/beaut-lg-tu2.gif" /></a></li>
        	<li><a href="<?php echo url('index/shopslogo/shopslogo'); ?>"><img src="__IMAGE__PATH__/beaut-lg-tu3.gif" /></a></li>
        	<li><a href="<?php echo url('index/shopslogo/shopslogo'); ?>"><img src="__IMAGE__PATH__/beaut-lg-tu2.gif" /></a></li>
        	<li><a href="<?php echo url('index/shopslogo/shopslogo'); ?>"><img src="__IMAGE__PATH__/beaut-lg-tu3.gif" /></a></li>
        	<li style="width:155px; border-right:0;"><a href="#"><img src="__IMAGE__PATH__/beaut-lg-tu2.gif" /></a></li>
        </ul>
    </div>
    
    <!--广告栏-->
    <div class="advertisement w1200">
    	<p style="text-align:center;font-size:15px;color:#000;line-height:74px;">民以食为天,人以根为本,良心做食品,说的就是钱峰</p>
    </div>
    ...
    <div class="shopping-content w1200">
    	<div class="sp-con-info">
        	<ul class="sp-info-r m-act beaut">
                <li>
                    <div class="li-top">
                        <a href="<?php echo url('index/details/details'); ?>" class="li-top-tu"><img src="__IMAGE__PATH__/beaut-con-li-tu2.gif" /></a>
                    ...
                    <div class="li-md">
                    	...
                    	<div class="md-r f-l">
                        	<button class="md-l-btn1" onclick="purchase()">立即购买</button>

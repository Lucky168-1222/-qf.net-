<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\wamp64\www\tp5\public/../application/index\view\personal\address.html";i:1503061085;s:66:"D:\wamp64\www\tp5\public/../application/index\view\index\head.html";i:1503104117;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>钱峰网-收货管理</title>
    ...
    <div class="personal w1200">
    	<div class="personal-left f-l">
            ...
            <ul>
                ...
                <li class="current-li per-li6"><a href="<?php echo url('index/personal/address'); ?>">管理收货地址<span>></span></a></li>
    	...
    	<div class="management f-r">
            <div class="tanchuang-con">
                ...
                <button class="btn-pst2" id="but_js">保存</button>
                <script type="text/javascript">
                var oBut = document.getElementById('but_js');
                oBut.onclick = function(){
                    document.location = "<?php echo url('index/personal/address'); ?>";
                }
                </script>
            </div>
            <div class="man-info">

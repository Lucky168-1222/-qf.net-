<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\wamp64\www\tp5\public/../application/index\view\cosmetology\exchange.html";i:1503068287;s:66:"D:\wamp64\www\tp5\public/../application/index\view\index\head.html";i:1503122744;}*/ ?>
<!DOCTYPE html PUBLIC>
<html>
<head>
    	...
    	<div class="integral-right f-r">
            ...
            <div class="int-r-con">
            	<ul class="int-con-ul1" style="display:block;">
                	<li>
                    	<a href="#"><img src="__IMAGE__PATH__/int-r-con-li-tu.gif" /></a>
                        <h3><a href="#">华菲型格官方旗舰店</a></h3>
                        <p class="p1">酒水饮料</p>
                        <p class="p2">减 <span>50</span> 满 300 可用</p>
                        <p class="p3">会员价：<span>3660积分</span></p>
                        <button class="md-l-btn1" onclick="purchase()">积分兑换</button>
                    </li>
                    <li>
                    	<a href="#"><img src="__IMAGE__PATH__/int-r-con-li-tu.gif" /></a>
                        <h3><a href="#">华菲型格官方旗舰店</a></h3>

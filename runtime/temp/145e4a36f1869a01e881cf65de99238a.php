<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\wamp64\www\tp5\public/../application/index\view\pay\payerror.html";i:1503065307;s:66:"D:\wamp64\www\tp5\public/../application/index\view\index\head.html";i:1503060905;}*/ ?>
...
<!-- <script type="text/javascript" src="__JS__PATH__/zhonglin.js"></script> -->
    ...
    <div class="payment w1200">
        ...
        <div class="payment-bd">
        	<dl class="dl-hd">
            	<dt><a href="#"><img src="__IMAGE__PATH__/in-matong3.gif" /></a></dt>
                <dd>
        ...
        <div class="payment-ft">
        	<button class="btn1" onclick="pay()" >重新支付</button>
        	<button class="btn2" onclick="order()">我的订单</button>
            <script type="text/javascript">
                function pay()
                {
                ...
                function order()
                {
                    document.location = "<?php echo url('index/personal/order'); ?>";
                }
            </script>
        </div>
    </div>

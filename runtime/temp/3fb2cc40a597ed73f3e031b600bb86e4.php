<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"D:\wamp64\www\tp5\public/../application/index\view\bus\four.html";i:1503123864;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <ul>
                    ...
                    <li class="last ">
                        <span>4. 等待审核</span>
                                    ...
                                    <div class="panel">
                        <form enctype="multipart/form-data" id="stepForm" method="post" action="<?php echo url('index/bus/five'); ?>" name="stepForm" onsubmit="return validate();">
                <div class="panel-content">
                    <div class="bg-warp">
                        <div class="title">
                            <span>添加品牌</span>
                        </div>
                                                                                    <div class="prompt"><div class="yel-tip">
<div class="content">
1. 信息提交前，请务必先了解
<a class="link-blue" target="_blank" href="">大商创开放平台招商资质标准细则；</a>
<br>
2. 经营品牌类信息需填项较多，建议先查看
<a class="link-blue" target="_blank" href="">品牌添加注意事项</a>
再进行填写；
<br>
...
<div class="panel-body mt30">
    <div class="panel-tit"><span>新品牌信息</span></div>
    <div class="mc">
    	<div class="list"> 
            <div class="item">
                <div class="label">
                ...
                <div class="value">
                	<input type="text" name="ec_brandName" id="brandName" size="20" value="sdff" class="text" >
            ...
            <div class="item">
                ...
                <div class="value">
                	<input type="text" name="ec_bank_name_letter" id="bank_name_letter" size="20" value="sdfg" class="text">
            ...
            <div class="item">
                ...
                <div class="value">
                	<input type="text" name="ec_brandFirstChar" id="brandFirstChar" size="20" value="s" class="text">
            ...
            <div class="item">
                ...
                <div class="value">
                	<input type="file" name="ec_brandLogo" id="brandLogo" style="margin-top:5px;"><input type="hidden" value="" name="text_brandLogo" id="textBrandLogo">
            ...
            <div class="item">
                ...
                <div class="value">
                	<input type="text" name="ec_brandEndTime" value=""  size="20" class="text text-2 jdate narrow fl" style=" float:left;" id="ec_brandEndTime">
                    <div class="cart-checkbox fl ml10">
                 		<input type="checkbox" class="ui-checkbox CheckBoxShop" onclick="get_brandEndTime_permanent(this, '')" name="ec_brandEndTime_permanent" value="1" id="brandEndTime_permanent" >
                        <label for="brandEndTime_permanent">永久</label> 
                    </div>
                    <input name="ec_shop_bid" type="hidden" value="0">
...
<div class="panel-body mt40">
    <div class="panel-tit"><span>请以下品牌资质扫描件</span></div>
...
if(document.getElementById('brandFirstChar')){	
	$(function(){
		...
		if($('#brandFirstChar').val() != '' && $('#brandFirstChar').val().length > 1){
			$("input[name='ec_brandFirstChar']").attr('','');
		}
...
xvDate(opts6);
                    ...
                    <input name="pid_key" type="hidden" value="3" />
                    ...
                    <input id="nextStepBtn" class="btn" type="submit" value="保存">
...
function removeBrandTable(obj,b_fid)
{
	if(b_fid > 0){
		if (confirm(merchants_step_remove)){
		   location.href = 'merchants_steps.php?step=stepThree&pid_key=2&ec_shop_bid=0&del_bFid=' + b_fid + '&brandView=brandView';
	   }
	}else{
...
function get_deleteBrand(bid){
	if (confirm(merchants_step_remove)){
		location.href = 'merchants_steps.php?step=stepThree&pid_key=2&ec_shop_bid=' + bid + '&del=deleteBrand';
	}
}
</script>
</html>
<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\wamp64\www\tp5\public/../application/index\view\cosmetology\saleshops.html";i:1503103861;s:66:"D:\wamp64\www\tp5\public/../application/index\view\index\head.html";i:1503122744;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>钱峰网-预约商品</title>
...
<!-- <script type="text/javascript" src="__JS__PATH__/zhonglin.js"></script> -->
        	...
        	<div class="shop-left-top">
                ...
                <dl class="drop">
                    ...
                    <dd click-chage="y2" style="display:none;">
                        <ul>
                            <li><a href="details.html">日用卫生巾</a></li>
                            <li><a href="details.html">夜用卫生巾</a></li>
                            <li><a href="details.html">护垫</a></li>
                            <li><a href="details.html">组合套装</a></li>
                            <li><a href="details.html">私处洗液</a></li>
                            <li><a href="details.html">女性湿巾</a></li>
                        </ul>
                    </dd>
                </dl>
                <dl class="drop">
                    ...
                    <dd click-chage="y3" style="display:none;">
                        <ul>
                            <li><a href="details.html">润唇膏</a></li>
                            <li><a href="details.html">BB霜</a></li>
                            <li><a href="details.html">隔离</a></li>
                            <li><a href="details.html">美容工具霜</a></li>
                            <li><a href="details.html">睫毛膏 </a></li>
                        </ul>
                    </dd>
                </dl>
                <dl class="drop">
                    ...
                    <dd click-chage="y4">
                        <ul>
                            <li><a href="details.html">洗面奶</a></li>
                            <li><a href="details.html">男士护肤</a></li>
                            <li><a href="details.html">洗护发</a></li>
                            <li><a href="details.html">沐浴露</a></li>
                            <li><a href="details.html">剃须护理</a></li>
                            <li><a href="details.html">防晒</a></li>
                        </ul>
                    </dd>
                </dl>
                <dl class="drop">
                    ...
                    <dd click-chage="y5">
                        <ul>
                            <li><a href="details.html">爽肤水</a></li>
                            <li><a href="details.html">面膜</a></li>
                            <li><a href="details.html">乳液</a></li>
                            <li><a href="details.html">面霜/眼霜</a></li>
                            <li><a href="details.html">防晒</a></li>
                            <li><a href="details.html">卸妆</a></li>
                            <li><a href="details.html">护肤套装</a></li>
                            <li><a href="details.html">洁面</a></li>
                        </ul>
                    </dd>
                </dl>
            </div>
    	...
    	<div class="shop-pg-right f-r">
        	<!-- <div class="shop-right-rmd">
            	<dl>
                	<dt>本店热销</dt>
                    <dd>
                    	<a href="details.html">大包</a>
                        <a href="details.html">中包</a>
                        <a href="details.html">小包</a>
                        <a href="details.html">豪华包房</a>
                        <a href="details.html">主题包房</a>
                    </dd>
                    <div style="clear:both;"></div>
                </dl>
                <dl>
        	...
        	<div class="shop-right-cmp">
            	<ul class="shop-cmp-l f-l">
                	<li class="current"><a href="details.html">综合 ↓</a></li>
                	<li><a href="details.html">销量 ↓</a></li>
                	<li><a href="details.html">新品 ↓</a></li>
                	<li><a href="details.html">评价 ↓</a></li>
                    <div style="clear:both;"></div>
                </ul>
            ...
            <div class="shop-right-con">
            	<ul class="real-ul">
					<li>
                        <a href="details.html"><img src="__IMAGE__PATH__/ktv-li-tu5.gif" /></a>
                        <a href="details.html" class="rl-tit">hello  kitty主题包房</a>
                        <span class="rl-sp1">新站区</span>
                        <p>意式墅区美宅 纯正意大利风情 </p>
                        <span class="rl-sp2">5980元/m2</span>
                        <button class="btn1" id="but_js" onclick="dianji()">立即预约</button>
                        <button class="btn2">加入购物车</button>

                    </li>
                    <li>
                        <a href="details.html"><img src="__IMAGE__PATH__/ktv-li-tu6.gif" /></a>
                        <a href="details.html" class="rl-tit">hello  kitty主题包房</a>
                        <span class="rl-sp1">新站区</span>
                        <p>意式墅区美宅 纯正意大利风情 </p>
                        <span class="rl-sp2">5980元/m2</span>
                    ...
                    <li>
                        <a href="details.html"><img src="__IMAGE__PATH__/ktv-li-tu7.gif" /></a>
                        <a href="details.html" class="rl-tit">hello  kitty主题包房</a>
                        <span class="rl-sp1">新站区</span>
                        <p>意式墅区美宅 纯正意大利风情 </p>
                        <span class="rl-sp2">5980元/m2</span>
                    ...
                    <li style="margin-right:0;">
                        <a href="details.html"><img src="__IMAGE__PATH__/ktv-li-tu8.gif" /></a>
                        <a href="details.html" class="rl-tit">hello  kitty主题包房</a>
                        <span class="rl-sp1">新站区</span>
                        <p>意式墅区美宅 纯正意大利风情 </p>
                        <span class="rl-sp2">5980元/m2</span>
            	...
            	<div class="pag-left f-l">
                	<a href="details.html" class="about left-r f-l"><</a>
                    <ul class="left-m f-l">
                    	<li><a href="details.html">1</a></li>
                        <li class="current"><a href="details.html">2</a></li>
                        ...
                        <li><a href="details.html">100</a></li>
                        <div style="clear:both;"></div>
                    </ul>
                	<a href="details.html" class="about left-l f-l">></a>
                    <div style="clear:both;"></div>
                </div>
    ...
    <div class="message-board w1200">
        ...
        <div class="mb-info">
        	<dl>
            	<dt><a href="details.html"><img src="__IMAGE__PATH__/message-board-tu.gif" /></a></dt>
                <dd>
                	<h3><a href="details.html">明天的希望</a></h3>
...
<script type="text/javascript">
function dianji(){
    document.location = "<?php echo url('index/details/saledetails'); ?>";
}

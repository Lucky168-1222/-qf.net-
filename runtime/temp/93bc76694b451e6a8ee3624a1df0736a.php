<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\wamp64\www\tp5\public/../application/index\view\shopslogo\shopslogo.html";i:1503107680;s:66:"D:\wamp64\www\tp5\public/../application/index\view\index\head.html";i:1503104117;}*/ ?>
<!DOCTYPE html PUBLIC>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>搜索列表页(店铺)</title>
...
<script type="text/javascript" src="__JS__zhonglin.js"></script>
</head>
...
<!-- <script type="text/javascript" src="__JS__PATH__/zhonglin.js"></script> -->
    ...
    <div class="sj-brand">
        <div class="sj-br-l f-l">
            <img src="__IMAGE__PATH__/sj-pingpai-tu.gif" />
        </div>
    ...
    <div class="brand-sales">
        <dl>
            <dt>本品牌热销</dt>
            <dd>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">坚果礼品</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">碧根果</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">松子</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">夏威夷果</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">核桃</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">葡萄干</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">花生</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">豆类制品</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">杏仁</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">枣类</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">瓜子</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">其他坚果</a><a href="<?php echo url('index/shopslogo/shopslogo'); ?>">坚果礼品</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">碧根果</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">松子</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">夏威夷果</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">核桃</a>
                ...
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">枣类</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">瓜子</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">其他坚果</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">坚果礼品</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">碧根果</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">松子</a>
                <a href="<?php echo url('index/shopslogo/shopslogo'); ?>">夏威夷果</a>
        ...
        <div class="shop-pg-left f-l" style="width:215px">
            <div class="shop-left-buttom" style="margin-top:0;">
                ...
                <ul class="shop-left-ul">
                    <li>
                        <div class="li-top">
                            <a href="" class="li-top-tu"><img src="__IMAGE__PATH__/sp-con-r-tu.gif" /></a>
                        ...
                        <div class="li-md">
                            ...
                            <div class="md-r f-l">
                                <button class="md-l-btn1" onclick="pay()">立即购买</button>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\wamp64\www\tp5\public/../application/index\view\personal\personal.html";i:1503060135;s:66:"D:\wamp64\www\tp5\public/../application/index\view\index\head.html";i:1503122744;}*/ ?>
<!DOCTYPE html">
<html>
    <head>
...
<!-- <script type="text/javascript" src="__JS__PATH__/zhonglin.js"></script> -->
    ...
    <div class="personal w1200">
    	<div class="personal-left f-l">
            ...
            <ul>
            	<ul>
                <li class="current-li per-li1"><a href="<?php echo url('index/personal/personal'); ?>">消息中心<span>></span></a></li>
    	...
    	<div class="personal-r f-r">
        	<div class="personal-right">
                ...
                <div class="theme">
                    ...
                    <p class="th-p2 f-l">
                        <img src="__IMAGE__PATH__/th-wenjian-tu.gif" />
                    </p>
                ...
                <div class="per-info">
                    ...
                    <ul>
                        <li>
                            <input type="checkbox" value="" name="hobby"></input>
                            <p class="p-tu f-l"><img src="__IMAGE__PATH__/th-wenjian-tu.gif" /></p>
                            <a href="persondetails.html" class="p-font f-l">亲爱的客户，欢迎注册外贸下单网站.....</a>
                ...
                <div class="per-info">
                    ...
                    <ul>
                        ...
                        <li>
                            <input type="checkbox" value="" name="hobby"></input>
                            <p class="p-tu f-l"><img src="__IMAGE__PATH__/th-wenjian-tu2.gif" /></p>
                            <a href="persondetails.html" class="p-font p-font1 f-l">亲爱的客户，欢迎注册外贸下单网站.....</a>
                            <p class="p-time f-l">2008年8月8日</p>
                            <div style="clear:both;"></div>
                        </li>
                    </ul>

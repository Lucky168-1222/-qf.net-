<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\wamp64\www\tp5\public/../application/index\view\pay\successpay.html";i:1503064789;}*/ ?>
...
<script type="text/javascript" src="__JS__PATH__jquery.js"></script>
...
<body style="position:relative;">
    ...
    <div class="top">
        <div class="top-con w1200">
            ...
            <ul class="t-con-r f-r">
                <li><a href="personal.html">我 (个人中心)</a></li>
                <li><a href="cart.html">我的购物车</a></li>
                <li><a href="confirmorder.html">我的订单</a></li>
                <li class="erweima">
                    <a href="#">扫描二维码</a>
                    <div class="ewm-tu">
    ...
    <div class="hd-info1 w1200">
        <div class="logo f-l">
            <h1><a href="#" title="中林网站"><img src="images/qianfeng.png" width="96" height="118" /></a></h1>
        </div>
        <div class="dianji f-r">
            <div class="btn1">
                <button class="btn1-l"><a href="register.html" >注册</a></button>
                <button class="btn1-r"><a href="sign.html" >登录</a></button>
                <div style="clear:both;"></div>
            </div>
        ...
        <div class="search f-r">
            <ul class="sp">
                <li  ss-search="sp"><a href="javascript:;" id="shopcom">商品</a></li>
                <div style="clear:both;"></div>
            </ul>
            <div class="srh">
                <div class="ipt f-l">
                ...
                <button class="f-r seek"><a href="room.html" >搜 索</a></button>
                <div style="clear:both;"></div>
            </div>
            <ul class="sp2">
                <li><a href="#">绿豆</a></li>
    ...
    <div class="payment w1200">
        ...
        <div class="payment-bd">
        	<dl class="dl-hd">
            	<dt><a href="#"><img src="images/in-matong3.gif" /></a></dt>
                <dd>
        ...
        <div class="payment-ft">
        	<button class="btn2"><a href="rder.html">我的订单</a></button>
        </div>
    </div>

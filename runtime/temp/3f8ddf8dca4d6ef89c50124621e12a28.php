<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\wamp64\www\tp5\public/../application/index\view\register\register.html";i:1503036868;}*/ ?>
...
<body style="background-image:url(__IMAGE__PATH__/bj.jpg);">

	<!--top 开始-->
    <div class="top">
    	<div class="top-con w1200">
        	<p class="t-con-l f-l">您好，欢迎来到钱峰网</p>
...
<!--     <div class="hd-info1 w1200">
    	<div class="logo f-l">
        	<h1><a href="#" title="中林网站"><img src="__IMAGE__PATH__/logo.jpg" /></a></h1>
        </div>
    ...
    <div class="password-con registered">
        ...
        <div class="yanzhentu">
        	<div class="yz-tu f-l">
            	<img src="__IMAGE__PATH__/psw-yanzhengtu.gif" />
            </div>
        ...
        <button class="psw-btn" id="register_id" >立即注册</button>
        <script type="text/javascript">
            var oBut = document.getElementById('register_id');

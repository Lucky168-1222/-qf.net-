<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\wamp64\www\tp5\public/../application/index\view\details\saledetails.html";i:1503057866;s:66:"D:\wamp64\www\tp5\public/../application/index\view\index\head.html";i:1503122744;}*/ ?>
    ...
    <div class="interface">
        ...
        <div class="commodity">
            <div class="matong f-l">
                <a href="#"><img src="__IMAGE__PATH__/in-matong.gif" /></a>
            </div>
        ...
        <div class="kehu">
            ...
            <button id="sale_js" >提交预约</button>
            <script type="text/javascript">
                var oBut = document.getElementById('sale_js');
                oBut.onclick = function(){
                    document.location = "<?php echo url('index/personal/reserve'); ?>";
                }
            </script>
        </div>
    </div>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\wamp64\www\tp5\public/../application/index\view\personal\collection.html";i:1503104657;s:66:"D:\wamp64\www\tp5\public/../application/index\view\index\head.html";i:1503122744;}*/ ?>
    ...
    <div class="personal w1200">
    	<div class="personal-left f-l">
            ...
            <ul>
                ...
                <li class="current-li per-li7"><a href="<?php echo url('index/personal/collection'); ?>">店铺收藏<span>></span></a></li>
            ...
            <div class="shop-con">
                ...
                <div class="shop-info">
                	<dl class="s-info-left f-l">
                    	<dt><a href="<?php echo url('index/shopslogo/shopslogo'); ?>"><img src="__IMAGE__PATH__/shop-info-dt-tu.gif" /></a></dt>
                        <dd>
                        	<h3><a href="<?php echo url('index/shopslogo/shopslogo'); ?>">三只松鼠旗舰店</a></h3>
                            <p><img src="__IMAGE__PATH__/songshu2-dt-h3.gif" /></p>
                            <p>卖家： 三只松鼠旗舰店</p>
                	...
                	<div class="s-info-right f-r">
                        ...
                        <div class="s-r-ul f-l" shuxingsw1="one">
                        	<ul class="s-r-ul2">
                                <li>
                                    <div class="tu">
                                        <a href="<?php echo url('index/details/details'); ?>"><img src="__IMAGE__PATH__/fa-r-con-li-tu2.gif" /></a>
                                    </div>
                                    <h3><a href="<?php echo url('index/details/details'); ?>">鹌鹑蛋卤蛋</a></h3>
                            ...
                            <ul class="s-r-ul2">
                                <li>
                                    <div class="tu">
                                        <a href="<?php echo url('index/details/details'); ?>"><img src="__IMAGE__PATH__/fa-r-con-li-tu3.gif" /></a>
                                    </div>
                                    <h3><a href="<?php echo url('index/details/details'); ?>">鹌鹑蛋卤蛋</a></h3>
                                    <p>¥ 29.90<span>¥ 62.00</span></p>
                                </li>
                            ...
                            <ul class="s-r-ul2">
                                <li>
                                    <div class="tu">
                                        <a href="<?php echo url('index/details/details'); ?>"><img src="__IMAGE__PATH__/fa-r-con-li-tu1.gif" /></a>
                                    </div>
                                    <h3><a href="<?php echo url('index/details/details'); ?>">鹌鹑蛋卤蛋</a></h3>
                                    <p>¥ 29.90<span>¥ 62.00</span></p>
                                </li>
                                ...
                                <li style="margin-right:0;">
                                    <div class="tu">
                                        <a href="<?php echo url('index/details/details'); ?>"><img src="__IMAGE__PATH__/fa-r-con-li-tu4.gif" /></a>
                                    </div>
                                    <h3><a href="<?php echo url('index/details/details'); ?>">鹌鹑蛋卤蛋</a></h3>
                                    <p>¥ 29.90<span>¥ 62.00</span></p>
                                </li>
                        ...
                        <a class="s-r-gd f-l" href="<?php echo url('index/shopslogo/shopslogo'); ?>">更多  >></a>
                    	<div style="clear:both;"></div>
                    </div>
                    <div style="clear:both;"></div>
                </div>
                ...
                <div class="shop-info">
                	...
                	<div class="s-info-right f-r">
                        ...
                        <a class="s-r-gd f-l" href="<?php echo url('index/details/details'); ?>">更多  >></a>
                    	<div style="clear:both;"></div>
                    </div>
                    <div style="clear:both;"></div>
                </div>

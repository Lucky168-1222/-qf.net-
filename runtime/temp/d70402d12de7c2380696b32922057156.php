<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\wamp64\www\tp5\public/../application/index\view\comment\comment.html";i:1503109837;s:66:"D:\wamp64\www\tp5\public/../application/index\view\index\head.html";i:1503104117;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<!-- <link href="__CSS__PATH__/bootstrap.min.css" rel="stylesheet"> -->
<link rel="stylesheet" type="text/css" href="__CSS__PATH__/star-rating.css" media="all"/>
...
<script type="text/javascript" src="__JS__PATH__/star-rating.js"></script>
<style type="text/css">
...
<!-- <script type="text/javascript" src="__JS__PATH__/zhonglin.js"></script> -->
  ...
  <!--内容开始-->
    <div class="evaluate w1200">
    	<dl class="eva-info1">
        	<dt><a href="#"><img src="__IMAGE__PATH__/want-evaluate-tu.gif" /></a></dt>
            <dd>
        ...
        <div class="eva-info3">
        	<div class="eva-if3-l f-l">
            	...
            	<dl class="if3-l-dl3">
                    ...
                    <dd>
                    	<a href="JavaScript:;">
                        	<img src="__IMAGE__PATH__/dl3-tu1.gif" />
                            <input type="file" class="img1" />
                        </a>
                        <a href="JavaScript:;">
                        	<img src="__IMAGE__PATH__/dl3-tu2.gif" />
                            <input type="file" class="img1" />
                        </a>
                        <p>上传图片     1/5</p>
                        <div style="clear:both;"></div>
                ...
                <button class="eva-btn" onclick="dianji()">提交评价</button>
                <script type="text/javascript">
                function dianji(){
                    document.location = "<?php echo url('index/personal/purchasenum'); ?>";
                }
                </script>
            </div>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\wamp64\www\tp5\public/../application/index\view\personal\integral.html";i:1503110162;s:66:"D:\wamp64\www\tp5\public/../application/index\view\index\head.html";i:1503122744;}*/ ?>
    ...
    <div class="personal w1200">
    	<div class="personal-left f-l">
            ...
            <ul>
                ...
                <li class="current-li per-li10"><a href="<?php echo url('index/personal/integral'); ?>">会员积分<span>></span></a></li>
            </ul>
        </div>
    	<div class="member f-r">
            <div class="mem-info1">
                ...
                <div class="mem-con1">
                	<dl class="f-l">
                    	<dt><a href="#"><img src="__IMAGE__PATH__/data-tu2.gif" /></a></dt>
                        <dd>
                        	<a href="#">RH了</a>
                    ...
                    <a href="<?php echo url('index/cosmetology/exchange'); ?>" class="duihuan f-l">兑换超值商品或参加活动</a>
                    <div style="clear:both;"></div>
                </div>
            </div>
            <div class="mem-info2">
                ...
                <div class="mem-con2">
                	<dl hpjf="gmsp">
                        ...
                        <dd>
                            <a href="<?php echo url('index/cosmetology/exchange'); ?>">去商城购物</a>
                        </dd>
                        <div style="clear:both;"></div>
                    </dl>
                    <dl hpjf="cjhd">
                        ...
                        <dd>
                            <a href="<?php echo url('index/cosmetology/exchange'); ?>">去商城活动</a>
                        </dd>
                        <div style="clear:both;"></div>
                    </dl>
                    <dl hpjf="qd">

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"D:\wamp64\www\tp5\public/../application/index\view\bus\five.html";i:1503124042;}*/ ?>
...
//加载效果
var load_cart_info = '<img src="__IAMGE__BUS__/load/loadGoods.gif" height="108" class="ml100">';
var load_icon = '<img src="__IAMGE__BUS__/load/load.gif" width="200" height="200">';
    ...
    <div class="w w1200">
        ...
        <div class="settled-header-right">
            <ul class="settled-nav">
                <li class="curr"><a href="merchants.php">首页</a></li>
...
</div><div class="container settled-container settled-prog-container">
    <div class="w w1200">
        <div class="sett-process-warp clearfix">
                                    <div class="panel">
                        <div class="settled-prog-warp">
                <div class="che"><img src="__IAMGE__BUS__/che.png"></div>
                <div class="spw-cont">
                    <div class="spw-tit"><h1>审核进度</h1></div>
                    
                    <div class="spw-mian spw-wait">
                        <i class="spw-icon"></i>
                        <div class="spw-info">
                            <h2>
                                                                正在审核中...                                                            </h2>
                            <div class="spw-txt">
                                <p>感谢您在本店申请商家入驻！</p>
                                                                <span>期望店铺名称：<strong class="orange2">4651515</strong></span>
                                <span>店铺描述：<em></em></span>
                                                            </div>
                                <div class="setted-footer">
	                                <a href="<?php echo url('index/index'); ?>" class="ftx-05">返回首页</a>
	                                <a href="<?php echo url('index/personal/orde'); ?>" class="ftx-05">用户中心</a>
	                            </div>
                        </div>
                    </div>
                </div>
...
function removeBrandTable(obj,b_fid)
{
	if(b_fid > 0){
		if (confirm(merchants_step_remove)){
		   location.href = 'merchants_steps.php?step=stepSubmit&pid_key=&ec_shop_bid=&del_bFid=' + b_fid + '&brandView=brandView';
	   }
	}else{
...
function get_deleteBrand(bid){
	if (confirm(merchants_step_remove)){
		location.href = 'merchants_steps.php?step=stepSubmit&pid_key=&ec_shop_bid=' + bid + '&del=deleteBrand';
	}
}
</script>
</html>
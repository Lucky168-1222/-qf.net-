<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\wamp64\www\tp5\public/../application/index\view\personal\purchasenum.html";i:1503108757;s:66:"D:\wamp64\www\tp5\public/../application/index\view\index\head.html";i:1503122744;}*/ ?>
    ...
    <div class="personal w1200">
    	<div class="personal-left f-l">
            ...
            <ul>
                ...
                <li class="current-li per-li8"><a href="<?php echo url('index/personal/purchaseNum'); ?>">购买记录<span>></span></a></li>
    	...
    	<div class="purchase-records f-r">
            ...
            <div class="pr-info">
                ...
                <div class="pr-con">
                	<div class="pr-con-tu f-l">
                    	<a href="<?php echo url('index/details/details'); ?>"><img src="__IMAGE__PATH__/dai1.gif" /></a>
                    </div>
                    <a class="pr-con-bt f-l" href="<?php echo url('index/details/details'); ?>">登高阁紫菜肉松鸡蛋卷海苔蛋卷 糕点江西特产小吃 休闲办公零食</a>
                    ...
                    <div class="pr-con-jiaoyi f-l">
                    	<a href="#">交易成功</a>
                    	<a href="<?php echo url('index/details/details'); ?>">订单详情</a>
                    </div>
                    <div class="pr-con-pj f-l">
                    	<a href="<?php echo url('index/comment/comment'); ?>">评价</a>
                    	<a href="<?php echo url('index/details/details'); ?>">再次购买</a>
                    </div>
            ...
            <div class="pr-info">
                ...
                <div class="pr-con">
                    ...
                    <div class="pr-con-pj f-l">
                    	<a href="<?php echo url('index/details/details'); ?>">评价</a>
                    	<a href="<?php echo url('index/details/details'); ?>">再次购买</a>
                    </div>
